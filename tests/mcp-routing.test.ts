...
describe('Agent Core MCP automatic capability routing', () => {
  it('replaces capability_recommend with capability_route while exposing 55 routed, github, memory, continuity, execution, artifact, workflow-advice, and observability tools', async () => {
